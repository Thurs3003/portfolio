...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success("Mensagem enviada! Responderei em até 24h.");
        setForm(INITIAL);
      } else {
        toast.error("Erro ao enviar. Tente o e-mail diretamente.");
      }
    } catch {
      toast.error("Erro ao enviar. Tente o e-mail diretamente.");
    } finally {
      ...
      <div className="contact-wrap">
        ...
        >
          ...
          <p className="contact-p">
            Disponível para projetos freelance de sites, landing pages,
            e-commerces e sistemas com Supabase. Respondo em até 24h.
          </p>
        ...
        >
          <form
            ...
            noValidate
            className={sending ? "form-sending" : ""}
          >
